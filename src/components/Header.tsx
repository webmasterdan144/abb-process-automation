      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="https://www.grossautomation.com/contact?utm_source=abbatow&utm_medium=website&utm_campaign=secure-redirect" className="text-abb-gray-700 hover:text-primary transition-colors">
              Contact
            </a>
          </nav>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-abb-gray-200">
            <div className="flex flex-col space-y-4">
              ...
              <a href="https://www.grossautomation.com/contact?utm_source=abbatow&utm_medium=website&utm_campaign=secure-redirect" className="text-abb-gray-700 hover:text-primary py-2">
                Contact
              </a>
